angular
  ...
  .config(function (SpotifyProvider) {
    ...
    SpotifyProvider.setRedirectUri('http://localhost:3000/test/examples/callback.html');
  ...
  .controller('MainController', ['$scope', 'Spotify', function ($scope, Spotify) {
    ...
    $scope.login = function () {
      Spotify.login().then(function (data) {
        ...
        .then(function(){
          Spotify.createPlaylist($scope.user.id, { name: 'Teste 5' })
          .then(function (data) {
            $scope.playlist = data;
          ...
          .then(function(){
            ...
            Spotify.addPlaylistTracks($scope.user.id, $scope.playlist.id, ['spotify:track:4iV5W9uYEdYUVa79Axb7Rh', 'spotify:track:1301WleyT98MSxVHPZCA6M'])
            .then(function (data) {
